...
function CabinRow({ cabin, num, go, reverse }) {
  ...
  } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "baseline" } }, /* @__PURE__ */ React.createElement("span", { className: "eyebrow" }, "\u2014 ", cabin.type), /* @__PURE__ */ React.createElement("span", { className: "pill" }, "From $", cabin.price, "/nt")), /* @__PURE__ */ React.createElement("h2", { style: {
