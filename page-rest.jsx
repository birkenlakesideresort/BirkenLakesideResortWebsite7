  ...
  return (
    <div className="page-fade">
      ...
      <section className="hero" style={{ padding: 0 }}>
        <div className="hero-img" role="img" aria-label="Outdoor wedding ceremony set in a cedar forest clearing at Birken Lakeside Resort, with wooden chairs and a fabric-draped arch overlooking Gates Lake" style={{ backgroundImage: 'url(assets/Wedding-outdoor-ceremony.jpeg)', backgroundPosition: 'center bottom' }} />
