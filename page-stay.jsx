  ...
  return (
    <article className="cabin-row-article" style={{
      ...
      <div role="img" aria-label="Exterior of the shared washroom facility at Birken Lakeside Resort" style={{
        order: 1, backgroundImage: 'url(assets/shared_washroom_exterior.jpeg)',
        backgroundSize: 'cover', backgroundPosition: 'center', minHeight: 460,
        backgroundColor: 'rgba(29,61,45,0.08)',
      }} />
      <div className="cabin-row-text" style={{ order: 2, padding: '56px 56px 48px', display: 'flex', flexDirection: 'column', gap: 16, justifyContent: 'center' }}>
        <span className="eyebrow">— What's Here</span>
        <h2 style={{ fontFamily: 'var(--serif)', fontSize: 'clamp(36px, 4vw, 64px)', lineHeight: 0.95, color: 'var(--forest)', letterSpacing: '0.02em' }}>Shared Washroom Facility</h2>
      ...
      <section className="cabin-detail-section" style={{ padding: '64px 40px 80px', background: 'var(--cream)' }}>
        <div className="section-inner cabin-detail-story" style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 64, alignItems: 'start' }}>
          <div>
            ...
            <h2 style={{ fontFamily: 'var(--serif)', fontSize: 'clamp(40px, 4.5vw, 72px)', lineHeight: 0.95, color: 'var(--forest)', letterSpacing: '0.02em', marginTop: 14 }}>Bright. Clean. Always on.</h2>
            <p style={{ fontSize: 19, lineHeight: 1.85, color: 'var(--stone)', marginTop: 24 }}>
