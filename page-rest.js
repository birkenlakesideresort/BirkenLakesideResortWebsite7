...
function Weddings({ go }) {
  return /* @__PURE__ */ React.createElement("div", { className: "page-fade" }, /* @__PURE__ */ React.createElement("section", { className: "weddings-hero", style: { position: "relative", height: "100vh", minHeight: 640, marginTop: "calc(-1 * var(--nav-h, 140px))", color: "var(--cream)", overflow: "hidden", padding: 0 } }, /* @__PURE__ */ React.createElement("div", { role: "img", "aria-label": "Wedding reception tables laid out on an open lakeside deck surrounded by cedar trees, with Gates Lake and mountains visible", style: { position: "absolute", inset: 0, backgroundImage: "url(assets/wedding-tables-lakeview.jpeg)", backgroundSize: "cover", backgroundPosition: "center" } }), /* @__PURE__ */ React.createElement("div", { className: "hero-shade" }), /* @__PURE__ */ React.createElement("div", { style: { position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: "flex-end", padding: "0 40px 80px", maxWidth: 1440, margin: "0 auto" } }, /* @__PURE__ */ React.createElement("span", { className: "eyebrow eyebrow-light", style: { color: "var(--cedar)" } }, "\u2014 04 / Weddings"), /* @__PURE__ */ React.createElement("h1", { style: { fontFamily: "var(--serif)", fontSize: "clamp(28px, min(10vw, 11svh), 160px)", lineHeight: 0.86, color: "var(--cream)", letterSpacing: "0.02em", marginTop: 18 } }, "GET MARRIED", /* @__PURE__ */ React.createElement("br", null), "IN THE WOODS."), /* @__PURE__ */ React.createElement("p", { className: "italic-quote", style: { color: "rgba(243,234,220,0.85)", fontSize: 20, marginTop: 18, maxWidth: 620 } }, "One wedding at a time. Your people, your playlist, your kind of vows."))), /* @__PURE__ */ React.createElement("section", { style: { padding: "120px 40px", background: "var(--cream)" } }, /* @__PURE__ */ React.createElement("div", { className: "section-inner" }, /* @__PURE__ */ React.createElement(
    SectionHead,
    {
      num: "\u2014 The Day",
...
function Area({ go }) {
  return /* @__PURE__ */ React.createElement("div", { className: "page-fade" }, /* @__PURE__ */ React.createElement("section", { className: "first-section", style: { padding: "80px 40px", background: "var(--cream)" } }, /* @__PURE__ */ React.createElement("div", { className: "section-inner" }, /* @__PURE__ */ React.createElement("span", { className: "eyebrow" }, "\u2014 06 / The Area"), /* @__PURE__ */ React.createElement("h1", { style: { color: "var(--forest)" } }, "55 MINUTES", /* @__PURE__ */ React.createElement("br", null), "FROM WHISTLER.", /* @__PURE__ */ React.createElement("br", null), "A DIFFERENT", /* @__PURE__ */ React.createElement("br", null), "PLANET."), /* @__PURE__ */ React.createElement("p", { className: "italic-quote", style: { fontSize: 20, marginTop: 28, maxWidth: 680 } }, "Old-growth cedar, swimming holes, a Saturday market, mountain country on the dry side. Here's what's near."))), /* @__PURE__ */ React.createElement("section", { style: { padding: "40px 40px 120px", background: "var(--cream)" } }, /* @__PURE__ */ React.createElement("div", { className: "section-inner" }, /* @__PURE__ */ React.createElement("div", { className: "area-grid", style: { gap: 64 } }, /* @__PURE__ */ React.createElement("div", { className: "area-list" }, AREA.map((a, i) => /* @__PURE__ */ React.createElement("article", { key: i, className: "area-item" }, /* @__PURE__ */ React.createElement("div", { className: "num" }, a.num), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h4", null, a.name), /* @__PURE__ */ React.createElement("p", null, a.desc)), /* @__PURE__ */ React.createElement("div", { className: "dist" }, a.dist)))), /* @__PURE__ */ React.createElement("div", { className: "area-map" }, /* @__PURE__ */ React.createElement(AreaMap, null))))));
}
function AreaMap() {
