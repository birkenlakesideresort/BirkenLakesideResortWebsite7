function Gatherings({ go }) {
  return /* @__PURE__ */ React.createElement("div", { className: "page-fade" }, /* @__PURE__ */ React.createElement("section", { className: "first-section", style: { padding: "80px 40px", background: "var(--cream)" } }, /* @__PURE__ */ React.createElement("div", { className: "section-inner" }, /* @__PURE__ */ React.createElement("span", { className: "eyebrow" }, "GATHERINGS"), /* @__PURE__ */ React.createElement("h1", { style: { color: "var(--forest)" } }, "Bring twenty.", /* @__PURE__ */ React.createElement("br", null), "Take over the whole place."), /* @__PURE__ */ React.createElement("p", { className: "italic-quote", style: { fontSize: 20, marginTop: 28, maxWidth: 680 } }, "Birken was built for gatherings. For groups of sixteen to thirty-two, the whole property is yours \u2014 seven cabins, three glamping tents, the Meeting Hall, the dock, the Grille on Saturday night. Full property exclusive use. No other guests. No surprises. Most weekends through peak season hold first for full-site book-outs and open second \u2014 so early enquiry matters. We send full details by email and walk you through the rest on a call."))), /* @__PURE__ */ React.createElement("section", { style: { padding: "0 40px 80px", background: "var(--cream)" } }, /* @__PURE__ */ React.createElement("div", { className: "section-inner" }, /* @__PURE__ */ React.createElement("ul", { style: { listStyle: "none", padding: 0, margin: 0, borderTop: "0.5px solid rgba(29,61,45,0.18)" } }, [
    ...
    marginBottom: 8
  } }, x.l), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 15, color: "var(--stone)", lineHeight: 1.6 } }, x.d)))))), /* @__PURE__ */ React.createElement("section", { style: { padding: "0 40px 120px", background: "var(--cream)", textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { className: "section-inner" }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 19, lineHeight: 1.8, color: "var(--stone)", maxWidth: 600, margin: "0 auto 32px" } }, "Ready to talk? We don't run buyouts through a checkout. Email us with your dates and your numbers, and we'll send a full inquiry pack within twenty-four hours."), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement("a", { className: "btn btn-primary", href: "mailto:hello@birkenlakesideresort.ca" }, "Enquire \u2014 hello@birkenlakesideresort.ca \u2192"), /* @__PURE__ */ React.createElement("a", { className: "btn btn-ghost", href: "#options-pdf-pending" }, "See options \u2192")))));
}
