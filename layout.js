...
function Nav({ route, go, transparent }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("nav", { className: `nav ${overDark ? "over-dark" : ""} ${scrolled ? "is-scrolled" : ""}` }, /* @__PURE__ */ React.createElement("div", { className: "nav-inner" }, /* @__PURE__ */ React.createElement("ul", { className: "nav-links" }, links.slice(0, 4).map((l) => /* @__PURE__ */ React.createElement("li", { key: l.id }, /* @__PURE__ */ React.createElement(
    ...
    l.label
  )))), /* @__PURE__ */ React.createElement("div", { className: "nav-logo nav-logo-img", onClick: () => go("home") }, /* @__PURE__ */ React.createElement("img", { src: "assets/Birken_Submark_Original.png", alt: "Birken Lakeside Resort Logo \u2014 Since 1906" })), /* @__PURE__ */ React.createElement("div", { className: "nav-right" }, /* @__PURE__ */ React.createElement("ul", { className: "nav-links", style: { marginRight: 8 } }, links.slice(4, 7).map((l) => /* @__PURE__ */ React.createElement("li", { key: l.id }, /* @__PURE__ */ React.createElement(
    "button",
    {
